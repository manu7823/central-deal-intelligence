      ...
      <section className="container mx-auto">
        <div className="max-w-screen-lg my-20">
          ...
          <p className="mb-2 text-gray-600">
            This Closed Beta Service Agreement ("Agreement") is entered into as
            of date of subscription by and between:
          </p>
          <p className="mb-2 text-gray-600">
            OMG E-Commerce GmbH (the “Company“), a company organized and
            existing under the laws of Germany, with its principal place of
            business at Damenstiftstraße 12 80331 München, and
          </p>
          <p className="mb-2 text-gray-600">
          ...
          <p className="mb-2 text-gray-600">
            Company is developing a service (the "Service") and desires to
            engage Beta Tester to participate in a closed beta testing program
            for the Service.
          </p>
          <p className="mb-2 text-gray-600">
            Beta Tester desires to participate in the closed beta testing
            program and to provide feedback to Company regarding the Service.
          </p>
          ...
          <ol className="list-decimal ml-4 mb-4">
            ...
            <li>
              <strong>Access to Service:</strong> Company will provide Beta
              Tester with access to the Service for the sole purpose of testing
              and evaluation during the beta testing period.
            </li>
            <li>
              ...
              features, functionality, and performance, confidential and will
              not disclose such information to any third party without the prior
            ...
            <li>
              <strong>Ownership:</strong> Beta Tester acknowledges that Company
              is the sole owner of all rights, title, and interest in and to the
            ...
            <li>
              ...
              other intangible losses, resulting from the use or inability to
              use the Service.
            </li>
            <li>
              <strong>Term and Termination:</strong> This Agreement shall
              commence on the Effective Date and shall continue until to be
              announced. Either party may terminate this Agreement at any time
